...
namespace coment
{
    ...
    inline void ComponentManager::updateEntityMaps(Entity e,
    ...
    inline void ComponentManager::onEntityAdded(const Entity& e)
    {
        // Add entity to array
    ...
    inline void ComponentManager::onEntityRemoved(const Entity& e)
    {
    ...
    inline void ComponentManager::postUpdate()
    {
